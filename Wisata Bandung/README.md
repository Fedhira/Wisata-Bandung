...
-   fully-functional authentication system, register and Input Data Wisata editing features built with Laravel
...
The profile can be accessed by a logged in user by clicking "**Input Data Wisata**" from the sidebar or adding **/create** in the url. The user can add information like birthday, gender, phone number, location, language or skills.
