<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
      <img src="../assets/img/tour.png" class="navbar-brand-img h-100" alt="...">
      <span class="ms-3 font-weight-bold">Wisata Bandung</span>
    </a>
  </div>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('index') ? 'active' : '') }}" href="{{ url('index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('index') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
          </div>
          <span class="nav-link-text ms-1">Data Wisata Bandung</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('create') ? 'active' : '') }} " href="{{ url('create') }}">
          ...
          <span class="nav-link-text ms-1">Input Data Wisata</span>
        </a>
      </li>
