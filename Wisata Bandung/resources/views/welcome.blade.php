...
<head>
    ...
    <style>
        ...
        body {
            ...
            margin: 0;
            padding: 0;
            background-image: url('https://wallpapers.com/images/featured/bandung-y1e3teeaol19en07.jpg');
...
<body>
    ...
    <div>
        <h1>Welcome to Wisata di Bandung</h1>
        <p>Explore the beauty of Bandung with us</p>
        <div class="card">
